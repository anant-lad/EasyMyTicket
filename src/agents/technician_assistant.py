...
class TechnicianAssistantAgent:
    ...
    def assist_technician(self, input_text: str, session_id: str = None, model: str = 'llama-3.3-70b-versatile') -> Dict[str, Any]:
        ...
        full_assistant_content = f"### Analysis\n{analysis}\n\n### Recommended Solution\n{solution}"
    ...
    def _build_conversational_prompt(self, current_ticket: Dict, query: str, similar_tickets: List[Dict], history: List[Dict]) -> str:
        ...
        **CRITICAL INSTRUCTIONS:**
        1. **DIRECT ADDRESS**: Address the technician directly using "You". Do NOT use third-person phrases like "The technician's query...".
        2. **FORMATTING**: Use Markdown. Use **Bold** for emphasis. Use bullet points or numbered lists for steps.
        3. **STRUCTURE**:
           - **Analysis**: Brief, high-level observation of the issue and potential blockers.
           - **Solution**: Clear, numbered step-by-step instructions.
        4. **TONE**: Professional, technical, and helpful.
        5. **ASK FOLLOW-UPS**: If the query is vague, ask specific questions to narrow it down.
        
        **Output Format (JSON):**
        {
            "analysis": "Brief observations about the issue (e.g., 'This indicates a kernel panic caused by...'). Use bullet points if multiple factors.",
            "solution": "Step-by-step troubleshooting guide. Use numbered lists (1., 2., 3.).",
            "sources": [
